  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-8">
        ...
        {row.example && (
          <p className="text-gray-600 dark:text-gray-400 italic border-l-4 border-primary/30 dark:border-primary/50 pl-4">
            &ldquo;{row.example}&rdquo;
          </p>
        )}
        {row.related_topic_ids?.length ? (
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Related topics</p>
