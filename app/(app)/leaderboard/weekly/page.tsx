  ...
  if (topIds.length === 0) {
    return (
      <section className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900/60 sm:p-5">
        ...
        <h2 className="mt-1 text-xl font-bold text-gray-900 dark:text-gray-100">Top learners this week</h2>
        ...
        <div className="mt-5 rounded-xl border border-dashed border-gray-300 bg-gray-50 px-4 py-6 text-sm text-gray-600 dark:border-gray-700 dark:bg-gray-800/60 dark:text-gray-300">
          No XP earned in the last 7 days. Complete lessons and quizzes to appear here.
        </div>
      </section>
    );
  }
    ...
    <section className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900/60 sm:p-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
        <div>
          ...
          <h2 className="mt-1 text-xl font-bold text-gray-900 dark:text-gray-100">Top learners this week</h2>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">XP earned in the last 7 days.</p>
        </div>
