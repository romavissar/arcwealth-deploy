...
export default async function AppLayout({
  ...
  if (userId) {
    ...
    const [resolvedRole, resolvedNotifications, tutorialState] = await Promise.all([
      getCurrentUserRole(),
      getMyNotifications(),
      getTutorialStateForUser(userId),
    ]);
    role = resolvedRole;
    notifications = resolvedNotifications;
    tutorialEnabled = tutorialState.shouldShowTutorial;
  }
  return (
